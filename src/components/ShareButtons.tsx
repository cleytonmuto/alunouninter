...
export default function ShareButtons({ postId, postTitle }: ShareButtonsProps) {
  ...
  const shareText = `${postTitle} - Aluno Uninter`;
  ...
  const handleInstagramShare = () => {
    // Instagram doesn't support direct web sharing API
    // Open Instagram web interface where users can manually create a post
    // On mobile, this will prompt to open the Instagram app if installed
